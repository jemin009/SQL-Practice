...
select * from orders;
------------------------------------------------------------------------------------------ 
-- 1. Show products having the 4th highest price. 
select 
	product_name,
	price
from products
...
-- 2. Show products having the 4th lowest price. 
select 
	product_name,
	price
from products
...
-- 3. Show all products belonging to the same category as the 3rd highest priced product. 
select 
	product_name,
	category,
	price
...
-- 4. Show all products belonging to the same category as the 3rd lowest priced product. 
select 
	product_name,
	category,
	price
...
-- 5. Show orders for the product having the 3rd highest price. 
select 
	order_id,
	customer_name,
	product_id
...
-- 6. Show orders for the product having the 3rd lowest price. 
select 
	order_id,
	customer_name,
	product_id
...
-- 7. Show all products belonging to the category of the product having the 2nd highest 
stock quantity. 
select 
	product_id,
	category,
...
-- 8. Show all products belonging to the category of the product having the 2nd lowest 
stock quantity. 
select 
	product_id,
	category,
...
-- 9. Show orders for the product having the 2nd highest stock quantity. 
select 
	o.order_id,
	o.product_id,
	o.customer_name
from orders o
where product_id = (select product_id from products p
					where stock_quantity = (select max(stock_quantity) from products
					where stock_quantity < (select max(stock_quantity) from products)));


-- 10. Show orders for the product having the 2nd lowest stock quantity. 
select 
	o.order_id,
	o.product_id,
	o.customer_name
...
-- 11. Show all products belonging to the category of the most expensive Electronics 
product. 
select 
	product_id,
	product_name,
...
-- 12. Show all products belonging to the category of the second cheapest Electronics 
product. 
select 
	product_id,
	product_name,
...
-- 13. Show orders placed for products belonging to the category of the second most 
expensive product. 
select 
	o.product_id,
	o.order_id
...
-- 14. Show orders placed for products belonging to the category of the second cheapest 
product. 
select 
	o.product_id,
	o.order_id
...
-- 15. Show products belonging to the category of the product whose price is exactly the 
average price. 
select 
	product_id,
	product_name
...
-- 16. Show products belonging to the category of the product whose stock quantity is 
exactly the average stock quan ty. 
select 
	product_id,
	product_name
from products
...
-- 17. Show orders for the product whose price is closest to the average product price. 
select
	o.order_id,
	o.product_id
from orders o
...
-- 18. Show orders for the product whose stock quan ty is closest to the average stock 
quantity. 
select
	o.order_id,
	o.product_id
from orders o
where product_id = (select product_id from products
					ORDER BY ABS(stock_quantity - (SELECT AVG(stock_quantity) FROM products))
				    ASC LIMIT 1);

-- 19. Show products belonging to the category of the 4th highest priced product. 
select 
	product_id,
	product_name,
	price
...
-- 20. Show orders for the product having the 4th highest price. 
select 
	o.order_id,
	o.product_id
from orders o
